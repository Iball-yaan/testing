      ...
      <Container>
        <Row className="d-flex justify-content-between">
          ...
          <p className="desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
             Repudiandae ipsam natus laboriosam doloremque maiores similique fugiat optio inventore,
              qui corporis.</p>
              <div className="no mb-1 mt-4">
                <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0">+62 678-5476-8965</p>
                </Link>
              </div>
              <div className="mail">
                <Link className="text-decoration-none">
          ...
          <h5 className="fw-bold mb-3">Subsrcibe untuk info Menarik</h5>
        ...
        <Row>
          ...
          ().getFullYear()} by <span className="fw-bold">Ngoding Mastery</span>, All Rights Reserved.
          </p>
          </Col>
        </Row>
      </Container>
